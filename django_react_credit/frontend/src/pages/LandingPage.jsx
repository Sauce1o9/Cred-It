        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              accuracy, and provide transferee students with faster and clearer
              results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Standardizes course comparison and credit accreditation between
                institutions
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Improves efficiency, transparency, and academic advising
                processes
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Faster, smarter decisions for both students and educational
                institutions
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 mb-12">
            <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
              Our system revolutionizes the traditional approach to credit
              evaluation by eliminating manual processes and introducing
              automated, intelligent assessment tools. Say goodbye to
